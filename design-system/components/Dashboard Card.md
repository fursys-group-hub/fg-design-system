...
|---|---|---|---|---|---|---|
| Dashboard Card | W×H 314×65, padding(TRBL) 16/20/16/20, radius 4 | **Grey-50 (#FFFFFF)** | Grey-200 (#EAEDF0) | Grey-50 (#FFFFFF), Grey-200 (#EAEDF0), Grey-900 (#000000) | Caption/Caption1-SemiBold, Title/Title4-SemiBold | — |
...
- Frame 4192 (frame) [레이아웃 가로(H) · 가로 fill/세로 hug · grow 1.0 · 크기 246×33]
  - 100 (text) [가로 hug/세로 hug · 크기 39×33] · 텍스트 Title/Title4-SemiBold · 색 Grey-900 (#000000)
...
- **내부 구조(가로 1줄):** `Tag`(상태) + [수치 `Title4` + 단위 `Caption1`]. 수치·라벨을 **세로로 쌓지 않는다.** 수치 색은 상태 연동(에러=`Red-600`, 포인트=`Blue-700`, 기본=`Grey-900`).
